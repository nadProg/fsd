...
export type UsePopperReturn<ReferenceElement extends HTMLElement,
  PopperElement extends HTMLElement> = {
...
export type PopperConfig<Modifiers> = Omit<Partial<PopperJS.Options>,
'modifiers'> & {
