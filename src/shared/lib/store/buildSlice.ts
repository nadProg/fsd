...
type SliceWithUseActions<State, CaseReducers extends SliceCaseReducers<State>, Name extends string = string> = Slice<
  State,
  CaseReducers,
  Name
> & {
...
): SliceWithUseActions<State, CaseReducers, Name> => {
